...
class ButtonBox(object):
    ...
    def __init__(self, msg, choices,title, images, default_choice, cancel_choice, callback):
        """ Create box object
        ...
        self.ui = GUItk(msg, choices,title,  images, default_choice, cancel_choice, self.callback_ui)
...
class GUItk(object):
    ...
    def create_msg_widget(self, msg):
        ...
        self.boxRoot.rowconfigure(0, weight=10, minsize='15m')

    def create_images_frame(self):
        self.imagesFrame = tk.Frame(self.boxRoot)
        row = 1
        self.imagesFrame.grid(row=row)
        self.boxRoot.rowconfigure(row, weight=10, minsize='15m')
    ...
    def create_images(self, filenames):
        ...
        for _r, images_row in enumerate(filenames):
            ...
            for column_number, filename in enumerate(images_row):
                ...
                self.imagesFrame.rowconfigure(row_number, weight=10, minsize='15m')
    ...
    def create_buttons(self, choices, default_choice):
        ...
        for row, (button_text, unique_button_text) in enumerate(zip(choices, unique_choices)):
            ...
            self.buttonsFrame.columnconfigure(i_hack, weight=50)
            i_hack += 1
