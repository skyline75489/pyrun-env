...
def choicebox(msg="Pick an item", choices=[],title="",  preselect=0,
              callback=None,
              run=True):
    """
    ...
    """
    mb = ChoiceBox(msg, choices, title,  preselect=preselect,
...
def multchoicebox(msg="Pick an item", choices=[], title="",
...
class ChoiceBox(object):
    ...
    def __init__(self, msg,  choices, title, preselect, multiple_select, callback):
        ...
        self.ui = GUItk(msg, self.choices,title,  preselect_list, multiple_select,
                        self.callback_ui)
...
class GUItk(object):
    ...
    def create_ok_button(self):
        ...
        okButton = tk.Button(self.buttonsFrame, takefocus=tk.YES,
                             text="OK", height=1, width=6,font=('微软雅黑',25))
        bindArrows(okButton)
    ...
    def create_cancel_button(self):
        cancelButton = tk.Button(self.buttonsFrame, takefocus=tk.YES,
                                 text="Cancel", height=1, width=6,font=('微软雅黑',25))
