...
def ynbox(msg="Shall I continue?", choices=("[<F1>]Yes", "[<F2>]No"),title=" ",
           image=None,
...
def ccbox(msg="Shall I continue?", choices=("C[o]ntinue", "C[a]ncel"), title=" ",
           image=None,
...
def boolbox(msg="Shall I continue?", choices=("[Y]es", "[N]o"),title=" ",
             image=None,
...
# indexbox
# -----------------------------------------------------------------------
def indexbox(msg="Shall I continue?",choices=("Yes", "No"),title=" ",
              image=None,
             default_choice='Yes', cancel_choice='No'):
    """
...
# msgbox
# -----------------------------------------------------------------------
def msgbox(msg="(Your message goes here)",image=None, ok_button="OK",title=" ",
             root=None):
    """
